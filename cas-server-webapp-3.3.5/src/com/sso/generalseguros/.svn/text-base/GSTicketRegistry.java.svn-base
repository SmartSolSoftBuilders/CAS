...
public final class GSTicketRegistry extends AbstractTicketRegistry {
     ...
     */
    public GSTicketRegistry(int initialCapacity, final float loadFactor, final int concurrencyLevel) {
