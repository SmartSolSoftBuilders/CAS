...
/**
 * Based on the 
 * Default In Memory Service Registry Dao.
 * 
 * @author Smart Solutions
 * 
 */
public final class GSServicesManagerImpl implements ReloadableServicesManager {
    ...
    public GSServicesManagerImpl( final ServiceRegistryDao serviceRegistryDao) {
